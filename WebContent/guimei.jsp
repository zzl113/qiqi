...
<div id="container">
	...
	<div class="login">
		<ul class="form f_l">
			...
			<li class="login_list"><label>会员名：</label><input type="text" name="tcus.loginname" />（可包含 a-z、0-9 和下划线）</li>
			<li class="login_list"><label>密&nbsp;&nbsp;&nbsp;码：</label><input type="text" name="tcus.password" />（至少包含 6 个字符）</li>
			<li class="a_c" ><input type="image" src="images/login.gif"
							onclick="return checkAll()"></li>
		...
		<ul class="aside f_l">
			...
			<li class="a_c"><a href="register.htm"><img src="images/registernow.gif" alt="现在就注册" /></a></li>
			<ul class="reged">
			<li class="regpic regpic5">您已经是会员？<a href="login2.html">由此登入</a></li>
			<li class="regpic regpic6">繁体中文用户由此<a href="register.jsp">注册</a></li>
			</ul>
		</ul>
	</div>
	</form>
