            ...
            <table>
                ...
                <tr>
                    <td class="td1">公告标题(*)：</td>
                     <input type="hidden" value="${At.id }" name="td">
                    <td class="td1"><label><input class="input" type="text"  value="${At.anntitle}"  name="wen" ></label></td>
                </tr>
                <tr class="tr2"></tr>
                <tr>
                    <td class="td2">公告内容：</td>
                    <td><label><textarea rows="6" cols="63"  name="tet"></textarea></label></td>
                </tr>
                <tr>
                    <td></td>
