...
<main>
 <section class="right">
            ...
            <form action="updateScate.action" method="post">
            <input type="hidden" name="scate.id" value="${scate.id}">
                <table style="width: 700px;">
                    <tr>
                        <td class="text">商品类别名称（*）：</td>
                        <td><input type="text" class="GG" value="${scate.catesname }" name="scate.catesname" onblur="checkClass()"></td>
                        <td id="result"></td>
                    </tr>
                    <tr>
                        <td class="text">所属大分类：</td>
                         ...
                         <select name="scate.pid">
                         	...
                         	<option value="${c.id}" <c:if test="${c.id==scate.pid}">
