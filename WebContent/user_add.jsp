...
<main>
        <section class="right">
            ...
            <form action="TuserAction!addTuser.action" method="post" onsubmit="return checkAll()">
                <table>
                  <tr>
                        <td class="Ntext"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="In" name="user.loginname"></td>
                        <td id="resultUserName"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">真实姓名（*）：</td>
                        <td><input type="text" class="In" name="user.realname"></td>
                        <td id="resultRealName"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">登录密码（*）：</td>
                        <td><input type="password" class="In" name="user.password"></td>
                        <td id="resultPwd"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">确认密码（*）：</td>
                        <td><input type="password" class="In" name="pad"></td>
                        <td id="resultRePwd"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">性别（*）：</td>
                        <td ><input type="radio" value="1" name="user.sex"><img src="images/Male.gif" >
                            <input type="radio" value="0" name="user.sex"><img src="images/Female.gif"></td>
                            <td id="resultSex"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">出生日期：</td>
                        <td><input type="text" class="In" name="user.birthday"></td>
                        <td id="resulBirthday"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">身份证：</td>
                        <td><input type="text" class="In" name="user.cardid"></td>
                        <td id="resultUser_id"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">电子邮件：</td>
                        <td><input type="text" class="In" name="user.email"></td>
                        <td id="resultEmail"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">手机号：</td>
                        <td><input type="text" class="In" name="user.tel"></td>
                        <td id="resultPhone"></td>
                    </tr>
                    <tr>
                        <td class="Ntext">地址（*）：</td>
                        <td><input type="text" class="In" name="user.address"></td>
